...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 14 mai 2022 à 22:20
...
(8, b'0', b'1', b'1', b'0', b'0', b'1', b'0', b'1', 'admin', '$2a$10$vsjRwUSUi2B/jlw4ATXEN.B2IIcVY8ourImFZnWcW1tLz3G6mLfpe', 8, 1),
...
(1, 2021, 1, 'A BIEN', NULL, 40, NULL, 'V', 5, 1),
(2, 2021, 1, 'T BIEN', NULL, 12, NULL, 'V', 7, 2);
...
(16, 'GEE1', 'GEE1', 7, 21),
(17, 'GC3HYD', 'GC3HYD', 3, NULL),
(18, 'GC3BPC', 'GC3BPC', 3, NULL),
(19, 'GI3GL', 'GI3GL', 2, NULL),
(20, 'GI3BI', 'GI3BI', 2, NULL),
(21, 'GEE2', 'GEE2', 7, 22),
(22, 'GEE3', 'GEE3', 7, NULL),
(23, 'GM1', 'GM1', 8, 24),
(24, 'GM2', 'GM2', 8, 25),
...
(5, 'U7777', 'oumaima@gmail.com', 'AZNAGI', 'Oumaima', NULL, 'Oumaima', 'Oumaima', '0677898'),
(7, 'U2222', 'yassin@gmail.com', 'BASMI', 'BASMI', NULL, 'Yassin', 'Yassin', '06554654'),
...
(39, 'U74245', 'hamid@gmail.com', 'BASSI', 'BASSI', NULL, 'Hamid', 'Hamid', '05447648');
...
--
ALTER TABLE `inscriptionannuelle`
  MODIFY `idInscription` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
